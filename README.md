...
| Use Case                | Feature                      | Details                                                                                                    | Priority | Agora Tools        | External Tools       |
| ----------------------- | ---------------------------- | ---------------------------------------------------------------------------------------------------------- | -------- | ------------------ | -------------------- |
| 1-1 Video Call          | Join a Session               | Request permissions, create RTC Engine, join channel, publish and subscribe                                | 1        | RTC & Token Server |                      |
|                         | Leave a Session              | Leave the channel                                                                                          | 1        | RTC                |                      |
|                         | Hear and see each other      | Enable video before joining channel                                                                        | 1        | RTC                |                      |
|                         | Mute Microphone              | Toggle microphone on engine, and show in UI                                                                | 1        | RTC                |                      |
|                         | Turn Video On/Off            | Toggle video on engine and show in UI                                                                      | 1        | RTC                |                      |
| Lecture Group Call      | Join a Session               | Request permissions, create RTC Engine, join channel, publish and subscribe                                | 1        | RTC & Token Server |                      |
|                         | Leave a Session              | Leave the channel                                                                                          | 1        | RTC                |                      |
|                         | Hear and see each other      | Enable video before joining channel                                                                        | 1        | RTC                |                      |
|                         | Mute Microphone              | Toggle microphone on engine, and show in UI                                                                | 1        | RTC                |                      |
|                         | Turn Video On/Off            | Toggle video on engine and show in UI                                                                      | 1        | RTC                |                      |
|                         | Mute every participant       | Instructor has the ability to mute everybody so they don't interrupt                                       | 2        | RTC                |                      |
|                         | Participant count            | Small counter showing how many students have joined, so instructor knows when they can start               | 2        | RTC                |                      |
|                         | Chat                         | In call chat, that can be toggled on and off                                                               | 2        | Agora Chat         |                      |
...
|                         | Create Session               | Tutors can create sessions that students can pay for and join                                              | 1        |                    | Supabase             |
| Leave Feedback & Rating | Post Call Survey             | After leaving the call, user sent to post call survey, which get's stored in the database for the teachers | 3        |                    | Supabase             |
