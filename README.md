...
| ----------------------- | ---------------------------- | ---------------------------------------------------------------------------------------------------------- | -------- | ------------------ | -------------------- | -------- |
| 1-1 Video Call          | Join a Session               | Request permissions, create RTC Engine, join channel, publish and subscribe                                | 1        | RTC & Token Server |                      | 0.25     |
|                         | Leave a Session              | Leave the channel                                                                                          | 1        | RTC                |                      | 0.25     |
|                         | Hear and see each other      | Enable video before joining channel                                                                        | 1        | RTC                |                      | 0.25     |
|                         | Mute Microphone              | Toggle microphone on engine, and show in UI                                                                | 1        | RTC                |                      | 0.25     |
|                         | Turn Video On/Off            | Toggle video on engine and show in UI                                                                      | 1        | RTC                |                      | 0.25     |
| Lecture Group Call      | Join a Session               | Request permissions, create RTC Engine, join channel, publish and subscribe                                | 1        | RTC & Token Server |                      | 0.25     |
|                         | Leave a Session              | Leave the channel                                                                                          | 1        | RTC                |                      | 0.25     |
|                         | Hear and see each other      | Enable video before joining channel                                                                        | 1        | RTC                |                      | 0.25     |
|                         | Mute Microphone              | Toggle microphone on engine, and show in UI                                                                | 1        | RTC                |                      | 0.25     |
|                         | Turn Video On/Off            | Toggle video on engine and show in UI                                                                      | 1        | RTC                |                      | 0.25     |
|                         | Mute every participant       | Instructor has the ability to mute everybody so they don't interrupt                                       | 2        | RTC                |                      | 1        |
|                         | Participant count            | Small counter showing how many students have joined, so instructor knows when they can start               | 2        | RTC                |                      | 0.5      |
|                         | Chat                         | In call chat, that can be toggled on and off                                                               | 2        | Agora Chat         |                      | 5-7      |
| Lesson Recording        | Record Lesson                | Save a recording of the lesson to a database                                                               | 3        | Cloud Recording    | AWS                  | 3        |
|                         | View Recorded Lesson         | Retrieve lesson, and show only to users who have paid for that session                                     | 3        |                    | AWS                  | 2        |
...
| Screen Share            | Toggle Screen Share          | Toggle screen share on engine, and update UI                                                               | -        | RTC                |                      | 2        |
|                         | Choose which screen to share | When screen share gets toggled, show a UI of which screen user wants to share                              | -        | RTC                |                      | 1        |
|                         | Permissions                  | Only participants on Web platform can screen share, the rest only viewers                                  | -        | RTC                |                      | 0.5      |
| Schedule a Session      | Display Tutors               | Show a list of tutors stored in the database with what they specialize and their ratings                   | 1        |                    | Firebase             | 1        |
|                         | Select Time                  | Can click into the tutor, and see available times for a session                                            | 1        |                    | Firebase             | 1        |
|                         | Pay for session              | Before students can join the session they have to pay using Stripe                                         | 2        |                    | GooglePay + ApplePay | 3-5      |
|                         | Create Session               | Tutors can create sessions that students can pay for and join                                              | 1        |                    | Firebase             | 1        |
| Leave Feedback & Rating | Post Call Survey             | After leaving the call, user sent to post call survey, which get's stored in the database for the teachers | 3        |                    | Firebase             | 2        |
